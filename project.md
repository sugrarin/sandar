...
- [x] Раздел `/profile` с данными пользователя
- [x] Тепловая карта активности (GitHub-style)
- [x] График точности по неделям
- [x] Статистика по режимам

### Фаза 2: Геймификация

- [x] Система достижений (achievements) — клиентский каталог + тост о новых
  - [x] "Первая тренировка"
  - [x] "10 идеальных раундов подряд" → реализован порог 5 и 10
  - [x] "Мастер умножения" / "Мастер деления"
  - [x] "Универсал" (все 6 режимов), "Снайпер" (≥95%), вопросы и тренировки
